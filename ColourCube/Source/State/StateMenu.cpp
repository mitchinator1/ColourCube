...
namespace State
{
	...
	void StateMenu::Init(std::shared_ptr<Display> display)
	{
		...
		m_UI->AddTextBox("Arial", "Longer text to test the speed of text. Should be a consistent speed from start to finish. It should also fit within the box nicely.");
